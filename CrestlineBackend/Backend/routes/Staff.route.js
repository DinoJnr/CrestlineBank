...
router.get('/accounts/:accountNumber/transactions', protect, getUserTransactions);
router.post('/transactions/:transactionId/reverse', protect, reverseTransaction);
...
router.patch('/accounts/:accountNumber/mandates/:mandateId', protect, updateMandateStatus);
router.delete('/accounts/:accountNumber/mandates/:mandateId', protect, cancelMandate);
router.post('/accounts/:accountNumber/signatories', protect, addSignatory);
router.delete('/accounts/:accountNumber/signatories/:signatoryId', protect, removeSignatory);
